*This project has been created as part of the 42 curriculum by [healeksa](https://profile.intra.42.fr/users/healeksa), [etamazya](https://profile.intra.42.fr/users/etamazya), [algaboya](https://profile.intra.42.fr/users/algaboya).*
...
| **[algaboya](https://profile.intra.42.fr/users/algaboya)** | PM / Developer | Developing the Chat service, handling DevOps (Docker, Prometheus), and managing tasks. |
...
| **Chat Functionality** | [algaboya](https://profile.intra.42.fr/users/algaboya) | Public/private channels, direct messaging, and blocking capabilities. |
| **Live Notifications** | [algaboya](https://profile.intra.42.fr/users/algaboya) | Real-time WebSocket alerts for game invites and friend requests. |
...
| **DevOps & Observability** | [algaboya](https://profile.intra.42.fr/users/algaboya) | Comprehensive monitoring & logging using Prometheus, Grafana, and ELK stack. |
...
| **Infrastructure for Log Management (ELK)** | Major (2pts) | Elasticsearch stores and indexes logs, Logstash collects and transforms them, and Kibana provides visualization dashboards for monitoring application behavior across all microservices. | [algaboya](https://profile.intra.42.fr/users/algaboya) |
| **Monitoring System (Prometheus + Grafana)** | Major (2pts) | Prometheus collects metrics via configured exporters across all microservices. Custom Grafana dashboards visualize backend health, traffic, and performance. Alerting rules and secured access are configured. | [algaboya](https://profile.intra.42.fr/users/algaboya) |
...
| **Advanced Chat Features** | Minor (1pt) | Extends the base chat with: block users from messaging, invite users to games directly from chat, game/tournament notifications, access to user profiles from chat, chat history persistence, and typing indicators. | [algaboya](https://profile.intra.42.fr/users/algaboya) |
...
### [algaboya](https://profile.intra.42.fr/users/algaboya)
